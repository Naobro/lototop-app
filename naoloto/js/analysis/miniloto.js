/* ============================================================
   ミニロト 分析ページ 初期化処理
   GitHub上のCSV（tousen.pyが更新するdata/miniloto_50.csv）を直接読み込み、
...
(async function () {
  const CONFIG = {
    ...
    bonusKey: 'ボーナス数字',
    mainCount: 5,
    positionBoundaries: [1, 10, 20],
    dataUrl: 'https://raw.githubusercontent.com/Naobro/lototop-app/main/data/miniloto_50.csv',
    dataFileName: 'tousen.py（ミニロト）',
    csvOptions: {
      mainCols: ['第1数字', '第2数字', '第3数字', '第4数字', '第5数字'],
      bonusCols: ['ボーナス数字'],
    },
    tierN: 24,
