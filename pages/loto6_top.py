...
# 数字列の列を数値に変換
num_cols = ['第1数字', '第2数字', '第3数字', '第4数字', '第5数字', '第6数字', 'ボーナス数字',
            '1等口数', '1等賞金', '2等口数', '2等賞金', '3等口数', '3等賞金',
            '4等口数', '4等賞金', '5等口数', '5等賞金', 'キャリーオーバー']
for col in num_cols:
...
st.markdown(f"""
<table>
<tr><th>回号</th><td>第{latest['回号']}回</td><th>抽選日</th><td>{latest['日付'].strftime('%Y-%m-%d')}</td></tr>
<tr><th>本数字</th><td colspan='3'>{latest['第1数字']} {latest['第2数字']} {latest['第3数字']} {latest['第4数字']} {latest['第5数字']} {latest['第6数字']}</td></tr>
<tr><th>ボーナス数字</th><td colspan='3'>({latest['ボーナス数字']})</td></tr>
<tr><th>1等</th><td>{latest['1等口数']}口</td><td colspan='2' style="text-align: right; font-weight: bold;">{latest['1等賞金']:,}円</td></tr>
<tr><th>2等</th><td>{latest['2等口数']}口</td><td colspan='2' style="text-align: right; font-weight: bold;">{latest['2等賞金']:,}円</td></tr>
<tr><th>3等</th><td>{latest['3等口数']}口</td><td colspan='2' style="text-align: right; font-weight: bold;">{latest['3等賞金']:,}円</td></tr>
<tr><th>4等</th><td>{latest['4等口数']}口</td><td colspan='2' style="text-align: right; font-weight: bold;">{latest['4等賞金']:,}円</td></tr>
<tr><th>5等</th><td>{latest['5等口数']}口</td><td colspan='2' style="text-align: right; font-weight: bold;">{latest['5等賞金']:,}円</td></tr>
<tr><th>キャリーオーバー</th><td colspan='3' style="text-align: right; font-weight: bold;">{latest['キャリーオーバー']:,}円</td></tr>
</table>
